...
:: CONFIGURATION
:: ==========================================
set "MY_SVC_NAME=AirGaugeService"
set "MY_SVC_DISPLAY=AirGaugeService (Python)"
@REM set "TARGET_EXE=C:\Users\user\Documents\python_webDev\sensorService\airgauge\src\bin\main.exe"
set "TARGET_EXE=C:\Users\user\Documents\python_webDev\sensorService\airgauge\src\bin\AirGaugeService.exe"
:: ==========================================
