...
def enforce_admin_access():
    ...
    try:
        ...
        # แก้ไขเงื่อนไขตรงนี้ให้อนุญาต supervisor ด้วย
        if user_role not in ['admin', 'supervisor']: # แก้แล้ว ถูกต้องครับ
            return json_response(message="Admin or Supervisor access required", status_code=403)
